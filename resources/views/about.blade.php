                ...
                @foreach($products as $product)
                    <div class="products-columns__item">
                        <div class="products-columns__item__title-product"><a
                                href={{route('product', ['product' => $product->id])}} class="products-columns__item__title-product__link">{{$product->name}}</a>
                        </div>
                        <div class="products-columns__item__thumbnail"><a
                                href={{route('product', ['product' => $product->id])}} class="products-columns__item__thumbnail__link"><img
